...
select players.first_name,players.last_name from teams INNER JOIN stats ON stats.team_id=teams.id INNER JOIN players ON players.id=stats.player_id WHERE year=2020 AND name="Chicago Cubs"
